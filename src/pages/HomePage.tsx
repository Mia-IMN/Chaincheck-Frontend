...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  const features: Feature[] = [
    {
      ...
      description:
        "Advanced on-chain analysis with millisecond precision data aggregation",
    ...
    },
    {
      ...
      description:
        "Multi-layer security analysis using machine learning algorithms",
    ...
    },
    {
      ...
      description:
        "Automated risk scoring and portfolio optimization strategies",
    ...
    },
    {
      ...
      title: "Sui Ecosystem",
      description:
        "Native integration with Sui blockchain and Move smart contracts",
  ...
  const handleTokenSearch = () => {
    ...
    const foundToken = displayTokens.find(
      (token) =>
  ...
  const TokenNotFoundModal = () => (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div
        className={`relative w-full max-w-md mx-4 p-6 rounded-2xl border backdrop-blur-xl ${
          isDark
      ...
      >
        ...
        <div className={`mb-6 ${isDark ? "text-slate-300" : "text-slate-600"}`}>
          ...
          <p className="text-sm">
            It may not exist or might be a new token. Please double-check the
            token details.
          </p>
        </div>
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Chaincheck breaks down token risks and red flags, so you don’t
              need to be a developer to understand what you’re buying.
            </p>

            <div className="relative max-w-3xl mx-auto mb-8 sm:mb-12 md:mb-16 px-4 sm:px-6 md:px-0">
              <div
                className={`relative backdrop-blur-xl rounded-xl sm:rounded-2xl border p-1.5 sm:p-2 ${
                  isDark
              ...
              >
                ...
                <div className="hidden sm:flex items-center">
                  <div className="flex-1 flex items-center">
                    <Search
                      className={`ml-4 md:ml-6 mr-3 md:mr-4 w-5 md:w-6 h-5 md:h-6 ${
                        isDark ? "text-slate-400" : "text-slate-500"
                      }`}
                    />
                    <input
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              ...
              <div className="text-center">
                ...
                >
                  {marketLoading
                    ? "..."
                    : marketStats.scamsDetected.toLocaleString()}
                </div>
                <div
                  className={`text-sm ${
                    isDark ? "text-slate-400" : "text-slate-600"
              ...
              <div className="text-center">
                ...
                >
                  {marketLoading
                    ? "..."
                    : marketStats.riskAssessments.toLocaleString()}
                </div>
                <div
                  className={`text-sm ${
                    isDark ? "text-slate-400" : "text-slate-600"
      ...
      <section
        className={`py-20 px-6 ${isDark ? "bg-slate-900/50" : "bg-white"}`}
      >
          ...
          <div className="flex items-center justify-between mb-12">
            ...
            <div className="flex items-center">
              <button
                ...
                className={`flex items-center px-1 py-2 rounded-lg text-sm font-medium transition-colors ${
                  isDark
                    ? "text-blue-400"
                    : "text-blue-600"
          ...
          {marketLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className={`p-6 rounded-2xl backdrop-blur-sm border animate-pulse ${
                    isDark
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <span>
                        {suiMainToken.price_change_percentage_24h?.toFixed(2) ||
                          "0.00"}
                        %
                      </span>
                    </div>
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    >
                      Supply:{" "}
                      {formatSupply(suiMainToken.circulating_supply || 0)}
                    </div>
                  </div>
                </div>
              </div>
      ...
      >
        <div className="absolute inset-0">
          <div
            className={`absolute top-1/4 right-1/4 w-72 h-72 rounded-full blur-3xl opacity-10 ${
              isDark ? "bg-blue-500" : "bg-blue-400"
            }`}
          ></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              Built for institutional investors, DeFi protocols, and
                ...
                <select
                  ...
                  onChange={(e) => {
                    const [sortBy, sortOrder] = e.target.value.split("-") as [
                      typeof marketFilters.sortBy,
                      typeof marketFilters.sortOrder
                    ];
                    setMarketFilters((prev) => ({
                      ...prev,
                      sortBy,
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0">
                ...
                >
                  {marketLoading
                    ? "Loading tokens..."
                    : `Showing ${(currentMarketPage - 1) * 20 + 1}-${Math.min(
                        currentMarketPage * 20,
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          console.log(
                            "🔗 Mobile Analyze button clicked for:",
                            token.name
                          );
              ...
              <table className="w-full">
                <thead className={`${isDark ? "bg-white/5" : "bg-gray-50"}`}>
                  <tr>
                    ...
                    <th
                      className={`px-6 py-4 text-right text-sm font-semibold hidden lg:table-cell ${
                        isDark ? "text-slate-300" : "text-slate-600"
                      }`}
                    >
                      Market Cap
                    ...
                    <th
                      className={`px-6 py-4 text-right text-sm font-semibold hidden xl:table-cell ${
                        isDark ? "text-slate-300" : "text-slate-600"
                      }`}
                    >
                      Volume
                    ...
                    <th
                      className={`px-6 py-4 text-center text-sm font-semibold hidden lg:table-cell ${
                        isDark ? "text-slate-300" : "text-slate-600"
                      }`}
                    >
                      Category
                  ...
                  {marketLoading ? (
                    ...
                    displayTokens.map((token, index) => (
                      ...
                      >
                        ...
                        <td
                          className={`px-6 py-4 text-right hidden lg:table-cell ${
                            isDark ? "text-slate-300" : "text-slate-600"
                          }`}
                        >
                          {token.marketCap}
                        ...
                        <td
                          className={`px-6 py-4 text-right hidden xl:table-cell ${
                            isDark ? "text-slate-300" : "text-slate-600"
                          }`}
                        >
                          {token.volume}
                        ...
                        <td className="px-6 py-4 text-center">
                          ...
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              console.log(
                                "🔗 Desktop Analyze button clicked for:",
                                token.name
                              );
                              try {
                                onAnalyzeToken(token);
